...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "nav.locations": "Stock Locations",
    "nav.analyses": "Stock Analyses",
    "nav.assistant": "OEMLine Assistant",
  ...
  nl: {
    ...
    "nav.stockManagement": "Voorraadbeheer",
    "nav.locations": "Voorraadlocaties",
    "nav.analyses": "Voorraadanalyses",
    "nav.assistant": "OEMLine Assistent",
